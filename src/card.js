...
const Card = (props) => {
  //dasfjasdlkjfqpoweiu
  //dfjkal;jsdf;ljkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkjkj
  ...
  return (
    <div>
      <div>
        <button className={button_css} onClick={handleEvent}>
          出来事を追加する
        </button>
          ...
          <div key={`${sort}-${EachEvent.id}`} className={card}>
            ...
            <div className={card_row}>
              ...
              <span className={input}>
                {EachEvent.readonly ? (
                  <input
                    defaultValue={EachEvent.incident}
                    type="text"
                    className="form-control"
                    placeholder="詳細"
            ...
            <div className={card_row}>
              ...
              <span className={input_number}>
                {EachEvent.readonly ? (
                  <input
                    defaultValue={EachEvent.happiness}
                    type="number"
                    className="form-control"
                    placeholder="詳細"
